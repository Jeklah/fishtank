...
fn setup_tank_system(
    ...
    commands.spawn((
        ...
        SceneBundle {
            ...
            scene: asset_server.load(
                    GltfAssetLabel::Scene(0).from_asset("embedded://fishtank/../assets/tank.glb"),
            ),
            ..default()
        },
    ));
    commands.spawn(SceneBundle {
        ...
        scene: asset_server.load(
            GltfAssetLabel::Scene(0).from_asset("embedded://fishtank/../assets/gravel.glb"),
        ),
        ..default()
    });
    ...
    commands.spawn(SceneBundle {
        transform: Transform::from_scale(Vec3::new(2., 0.6, 2.0))
            ...
            .with_rotation(Quat::from_rotation_x(-PI / 2.)),
        scene: asset_server
                .load(GltfAssetLabel::Scene(0).from_asset("embedded://fishtank/../assets/base.glb")),
        ..default()
    });
    ...
    commands.spawn(SceneBundle {
        ...
        scene: asset_server
                .load(GltfAssetLabel::Scene(0).from_asset("embedded://fishtank/../assets/frame.glb")),
        ..default()
    });
    ...
    coral_bundle_1.mesh = asset_server.load(
        ...
        .from_asset("embedded://fishtank/../assets/coral.glb"),
    );
    ...
    let rock_bundle = SceneBundle {
        scene: asset_server
            .load(GltfAssetLabel::Scene(0).from_asset("embedded://fishtank/../assets/rocks.glb")),
        ..default()
    };
